const Footer = () => (
  <footer className="relative py-12 border-t border-stone-200 dark:border-stone-800/40 bg-[#F0F5FF] dark:bg-[#070D1A]/90">
    ...
    <div className="relative max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
      ...
      <div className="hidden md:block w-px h-10 bg-gradient-to-b from-transparent via-blue-400/30 to-transparent" />
      ...
      <div className="flex items-center gap-6">
        <a
          ...
          className="group relative font-body text-sm text-stone-600 dark:text-stone-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300"
        >
          Email
          <span className="absolute -bottom-0.5 left-0 w-0 h-px bg-gradient-to-r from-blue-500 to-blue-400 group-hover:w-full transition-all duration-300" />
        </a>
        <a
