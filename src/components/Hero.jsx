  ...
  return (
    <section className="relative min-h-[100vh] flex flex-col pt-24 pb-16">
      ...
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12 md:gap-16">
        ...
        >
          <motion.p
            className="font-body text-[11px] uppercase tracking-[0.4em] text-stone-500 dark:text-stone-500 mb-5"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <div className="relative">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              ...
              <div className="h-px bg-gradient-to-r from-transparent via-stone-300 dark:via-stone-700 to-transparent my-6" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-full bg-stone-900 dark:bg-white text-white dark:text-stone-900 font-heading text-xs font-semibold tracking-wide hover:scale-105 shadow-md transition-all duration-300"
                >
